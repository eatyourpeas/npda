...
CSV_DATA_TYPES = {
    ...
    "Ethnic Category": "str",
    "Diabetes Type": "str",
    "Date of Diabetes Diagnosis": "str",
    "Date of leaving service": "str",
    "Reason for leaving service": "str",
    "Death Date": "str",
    "GP Practice Code": "str",
    "PDU Number": "str",
    "Visit/Appointment Date": "str",
    "Patient Height (cm)": "float64",
    "Patient Weight (kg)": "float64",
    "Observation Date (Height and weight)": "str",
    "Hba1c Value": "float64",
    "HbA1c result format": "str",
    "Observation Date: Hba1c Value": "str",
    "Diabetes Treatment at time of Hba1c measurement": "str",
    ...
    "Systolic Blood Pressure": "int16",  # Example of small integer encoding
    "Diastolic Blood pressure": "int16",  # Example of small integer encoding
    "Observation Date (Blood Pressure)": "str",
    "Foot Assessment / Examination Date": "str",
    "Retinal Screening date": "str",
    "Retinal Screening Result": "str",
    "Urinary Albumin Level (ACR)": "float64",
    "Observation Date: Urinary Albumin Level": "str",
    "Albuminuria Stage": "str",
    "Total Cholesterol Level (mmol/l)": "float64",
    "Observation Date: Total Cholesterol Level": "str",
    "Observation Date: Thyroid Function": "str",
    "At time of, or following measurement of thyroid function, was the patient prescribed any thyroid treatment?": "str",
    "Observation Date: Coeliac Disease Screening": "str",
    "Has the patient been recommended a Gluten-free diet?": "str",
    "Observation Date - Psychological Screening Assessment": "str",
    "Was the patient assessed as requiring additional psychological/CAMHS support outside of MDT clinics?": "str",
    "Does the patient smoke?": "str",
    "Date of offer of referral to smoking cessation service (if patient is a current smoker)": "str",
    "Date of Level 3 carbohydrate counting education received": "str",
    "Was the patient offered an additional appointment with a paediatric dietitian?": "str",
    "Date of additional appointment with dietitian": "str",
    "Was the patient using (or trained to use) blood ketone testing equipment at time of visit?": "str",
    "Date that influenza immunisation was recommended": "str",
    "Date of provision of advice ('sick-day rules') about managing diabetes during intercurrent illness or episodes of hyperglycaemia": "str",
    "Start date (Hospital Provider Spell)": "str",
    "Discharge date (Hospital provider spell)": "str",
    "Reason for admission": "str",
    "Only complete if DKA selected in previous question: During this DKA admission did the patient receive any of the following therapies?": "str",
